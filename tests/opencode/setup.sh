...
mkdir -p "$HOME/.config/opencode/austinpowers"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/austinpowers/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/austinpowers/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/austinpowers/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/austinpowers.js" "$HOME/.config/opencode/austinpowers/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/austinpowers/.opencode/plugins/austinpowers.js" \
       "$HOME/.config/opencode/plugins/austinpowers.js"
...
echo "Plugin installed to: $HOME/.config/opencode/austinpowers/.opencode/plugins/austinpowers.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/austinpowers.js"
