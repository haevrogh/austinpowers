...
# IMPORTANT: Run from austinpowers directory so local dev skills are available
...
if grep -q '"name":"Skill".*"skill":"austinpowers:subagent-driven-development"' "$SESSION_FILE"; then
