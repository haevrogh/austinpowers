...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/austinpowers
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/austinpowers-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using austinpowers:subagent-driven-development. The plan is at: $PLAN_PATH"
